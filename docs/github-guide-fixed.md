...
Это руководство описывает процедуры работы с GitHub в проекте HTXEnterface_v2, включая инициализацию репозитория, настройку GitHub Actions и создание Pull Request'ов.
