...
class WebSocketManager:
    ...
    def disconnect(self, websocket: WebSocket):
        ...
        if metadata:
            logger.info(f"User {metadata['user_id']} disconnected from WebSocket for symbol {metadata['symbol']}")
...
async def handle_websocket_message(websocket: WebSocket, data: dict, symbol: str, user: User):
